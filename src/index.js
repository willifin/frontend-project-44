...
export const randomNumberGame = () => {
	let randomNumberGameIndex = Math.floor(Math.random()*10+5);
...
export const logics = (explanationGame, questionForGame, conditionGame, falseGameResultLogics) => {
	...
	for (let i = 0; i < 3; i += 1) {
	let randomNumberGameLogics = randomNumberGame ();
	let questionForGameLogics = questionForGame(randomNumberGameLogics);
